...
predIdx <- vsurfT[[if (length(vsurfT[["varselect.pred"]])) "varselect.pred"
                   else "varselect.interp"]]
predT <- tPredictors[predIdx]
...
set.seed(901) # Consistent output for fig. 3
