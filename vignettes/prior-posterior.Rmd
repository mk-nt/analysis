...
OutputPlot("priorPost", 7.2, 3.2, function() {
  par(mfrow = c(1, 3), mar = c(4.2, 4.2, 1.2, 1))
  message(
    "rho = ",
    InformationGain(projects, tModels, "rate_neo", "nCoded", yTop = 250)$estimate |>
      signif(3)
  )
  Panel(1, 4)
  ...
  message(
    "rho = ",
    InformationGain(projects, nModels, "rate_loss", "neoCells", yTop = 12)$estimate |>
      signif(3)
  )
  Panel(2)
  ...
  message(
    "rho = ",
    InformationGain(projects, nsModels, "root_freqs.1.", "neoCells",
