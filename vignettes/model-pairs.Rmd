...
OutputPlot("modelCmp", wd, wd * mfr[1] / mfr[2] * spaceForOma, function() {
  ...
  Panel(3, 4)
  text(2.5, 70, "\U2191 g\U2013l asymmetry improves ML")
  ...
  Panel(5)
  text(2.5, 13, expression("\U2191 Unlinking" ~ italic("t") ~ "improves ML"))
  text(2.5, -9.6, expression("\U2193 Linking" ~ italic("t") ~ "improves ML"))
