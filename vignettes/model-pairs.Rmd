...
```{r model-comparison, fig.width = 6, fig.height = 12.04}
wd <- 6
mfr <- c(4, 2)
spaceForOma <- 1.02
OutputPlot("modelCmp", wd, wd * mfr[1] / mfr[2] * spaceForOma, function() {
  ...
  Panel(3, 4)
  text(2.5, 71, "\U2191 g\U2013l asymmetry improves ML")
  text(2.5, -16.35, "\U2193 gain\U2013loss symmetry improves ML", xpd = NA)
  ...
  Panel(5)
  text(2.5, 12.5, expression("\U2191 Unlinking" ~ italic("t") ~ "improves ML"))
  text(2.5, -6.2, expression("\U2193 Linking" ~ italic("t") ~ "improves ML"))
  ...
  Panel(6)
  text(2.5, 46, expression("\U2191 Non-stnry model improves ML"))
  ...
  text(1, 56.5, expression("\U2191 Heterog. model improves ML"))
  Panel(7)
  ...
  Panel(8)
  text(2.5, 34, expression("\U2191 Complex model improves ML"))
  text(2.5, -15.8, expression("\U2193 Simple model improves ML"), xpd = NA)
})
```
